...
from dh_MGMOCVRP.MGMOCVRPProblemDef import augment_data
...
class CVRPTester:
    ...
    def _test_one_batch(self, edge_attr, edge_to_node, demands, batch_size, episode):
        ...
        if aug_factor > 1:
            ...
            self.env.edge_attr, self.env.edge_to_node, self.env.demands, aug_factors = augment_data(self.env.edge_attr, self.env.edge_to_node, self.env.demands, aug_factor)
