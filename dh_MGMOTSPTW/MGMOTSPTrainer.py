...
class TSPTrainer:
    ...
    def _train_one_batch(self, batch_size):
        ...
        self.env.service_time = self.env.service_time.repeat(self.samples_h1, 1)
        self.env.tw_start = self.env.tw_start.repeat(self.samples_h1, 1)
        self.env.tw_end = self.env.tw_end.repeat(self.samples_h1, 1)
