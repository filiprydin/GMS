...
class TSPTester:
    ...
    def run(self, shared_problem, prefs, edge_to_node, print_results=True):
        ...
        while episode < test_num_episode:
            ...
            sols = self._test_one_batch(shared_problem, edge_to_node, batch_size, episode)
    ...
    def _test_one_batch(self, shared_problem, edge_to_node, batch_size, episode):
        ...
        if aug_factor > 1:
            ...
            self.env.problems, self.env.edge_to_node, aug_factors = augment_data(self.env.problems, self.env.edge_to_node, aug_factor)
