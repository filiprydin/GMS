...
from eb_MGMOTSPTW.MGMOTSPTester import TSPTester
...
def main(n_sols = 101):
    ...
    if tester_params['data_load_path'] is not None:
        ...
        edge_attr, edge_to_node, service_time, tw_start, tw_end = get_random_problems(env_params['distribution'], tester_params['test_episodes'], env_params['problem_size'], env_params['emax'])
